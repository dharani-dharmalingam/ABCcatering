...
const MedicalPlanBCBSAlternativeHDHP = () => {
      ...
      <section className="relative h-48 md:h-56 bg-gradient-to-r from-gray-600 to-gray-700 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-4 px-6">
          <h1 className="text-4xl lg:text-6xl font-bold text-white drop-shadow-lg">
            Medical Plan - BCBS Alternative HDHP
          </h1>
          <p className="text-xl text-white/90 max-w-2xl mx-auto drop-shadow-md">
            Blue Cross Blue Shield Alternative High Deductible Health Plan with cost-effective coverage
          </p>
        </div>
      </section>
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 space-y-8">
        ...
        <Card className="p-6">
          <div className="aspect-video w-full print:hidden">
            <VideoPlaceholder title="BCBS Alternative HDHP Video" />
          </div>
        </Card>
        ...
        <Card className="p-6">
          ...
          <p className="text-muted-foreground mb-6">
            Bi-weekly associate payroll contributions for Alternative HDHP coverage
          </p>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                ...
                <li>This plan's deductible is $3,400 for individual coverage, and $6,800 for family coverage when you visit in-network providers</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                ...
                <li>This plan's in-network out-of-pocket maximum is $6,350 for individual coverage, and $12,700 for family coverage</li>
              </ul>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6">
          ...
          <p className="text-muted-foreground mb-6">
            Comprehensive coverage details for Alternative HDHP - HSA eligible plan
          </p>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="text-center bg-abc-blue text-white font-semibold">Alternate HDHP (you pay)</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                <TableRow>
                  <TableCell className="font-medium">Annual deductible</TableCell>
                  <TableCell className="text-center">$3,400 per person<br />$6,800 family maximum</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className="font-medium">Out-of-pocket maximum</TableCell>
                  <TableCell className="text-center">$6,350 per person<br />$12,700 family maximum</TableCell>
                </TableRow>
                <TableRow>
                ...
                <TableRow>
                  <TableCell className="font-medium">Out-of-pocket maximum</TableCell>
                  <TableCell className="text-center">$10,000 | $20,000</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </div>
        ...
        <BenefitsNavigation currentRoute="/benefits/medical-plan-bcbs-alternative-hdhp" />
      </div>
      <Footer />
    </div>
  );
...
export default MedicalPlanBCBSAlternativeHDHP;
