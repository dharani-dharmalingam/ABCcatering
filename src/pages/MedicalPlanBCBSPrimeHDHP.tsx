...
const MedicalPlanBCBSPrimeHDHP = () => {
      ...
      <section className="relative h-48 md:h-56 bg-gradient-to-r from-gray-600 to-gray-700 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-4 px-6">
          <h1 className="text-4xl lg:text-6xl font-bold text-white drop-shadow-lg">
            Medical Plan - BCBS Prime HDHP
          </h1>
          <p className="text-xl text-white/90 max-w-2xl mx-auto drop-shadow-md">
            Blue Cross Blue Shield Prime High Deductible Health Plan with HSA compatibility
          </p>
        </div>
      </section>
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 space-y-8">
          ...
          <div className="space-y-4 text-black">
            ...
            <Alert className="border-green-500/50 bg-green-500/10">
              ...
              <AlertDescription className="text-green-600">
                <strong>HSA Eligible:</strong> This plan is eligible for a Health Savings Account (HSA), allowing you to save tax-free for medical expenses.
              </AlertDescription>
            </Alert>
          </div>
        </Card>
        ...
        <Card className="p-6">
          <div className="aspect-video w-full print:hidden">
            <VideoPlaceholder title="BCBS Prime HDHP Video" />
          </div>
        </Card>
        ...
        <Card className="p-6">
          ...
          <p className="text-black mb-6">
            Bi-weekly associate payroll contributions for Prime HDHP coverage
          </p>
          ...
          <div className="space-y-6">
            <Alert className="border-blue-500/50">
              ...
              <AlertDescription className="text-black">
                For HDHP plan, you'll need to meet your deductible before plan starts covering most services. Preventive care services are one exception and are fully covered without deductible being met.
              </AlertDescription>
            </Alert>

            <div>
              <h3 className="text-xl font-semibold text-abc-primary mb-2">Coinsurance</h3>
              <ul className="list-disc pl-6 space-y-2 text-black">
                <li>Once your deductible is met, the plan will pay for covered services according to the coinsurance rate.</li>
                <li>The plan will cover 80% for in-network services like primary care visits, specialist office visits, inpatient care, and urgent care visits, while you remain responsible for the remainder.</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 text-black">
                ...
                <li>This plan's deductible is $1,800 for individual coverage, and $3,600 for family coverage when you visit in-network providers.</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 text-black">
                ...
                <li>This plan's in-network out-of-pocket maximum is $4,500 for individual coverage, and $9,000 for family coverage.</li>
              </ul>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6">
          ...
          <p className="text-black mb-6">
            Comprehensive coverage details for Prime HDHP - HSA eligible plan
          </p>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="text-center bg-abc-blue text-white font-semibold">Prime HDHP (you pay)</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                <TableRow>
                  <TableCell className="font-medium">Annual deductible</TableCell>
                  <TableCell className="text-center">$1,800 single coverage<br />$3,600 family coverage</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className="font-medium">Out-of-pocket maximum</TableCell>
                  <TableCell className="text-center">$4,500 single coverage<br />$9,000 family coverage</TableCell>
                </TableRow>
                <TableRow>
                ...
                <TableRow>
                  ...
                  <TableCell className="text-center">20% after deductible</TableCell>
                </TableRow>
                <TableRow>
                ...
                <TableRow>
                  <TableCell className="font-medium">Annual Deductible</TableCell>
                  <TableCell className="text-center">$3,000 | $6,000</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className="font-medium">Coinsurance (your share)</TableCell>
                ...
                <TableRow>
                  <TableCell className="font-medium">Out-of-pocket maximum</TableCell>
                  <TableCell className="text-center">$6,000 | $12,000</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </div>
        ...
        <Card className="p-6">
          ...
          <p className="text-black mb-6">
            Prescription costs are determined by the tier assigned to each specific prescription drug. Deductible applies before copays.
          </p>
            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell className="text-center">Covered 100%</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className="font-medium">Pharmacy Deductible</TableCell>
                  <TableCell className="text-center">Combined with Medical</TableCell>
                </TableRow>
                ...
                <TableRow>
                  ...
                  <TableCell className="text-center">$15 copay after ded</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>Tier two</TableCell>
                  <TableCell className="text-center">$50 copay after ded</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>Tier three</TableCell>
                  <TableCell className="text-center">$90 copay after ded</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>Speciality</TableCell>
                  <TableCell className="text-center">$15/$50/$90 copay after ded</TableCell>
                </TableRow>
                <TableRow className="bg-blue-50">
                ...
                <TableRow>
                  <TableCell>Tier one</TableCell>
                  <TableCell className="text-center">$30 copay after ded</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>Tier two</TableCell>
                  <TableCell className="text-center">$100 copay after ded</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>Tier three</TableCell>
                  <TableCell className="text-center">$180 copay after ded</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>Speciality</TableCell>
                  <TableCell className="text-center">$30/$100/$180 copay after ded</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </div>
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            <p className="text-black">Available anywhere via Teladoc</p>
            <ul className="list-disc pl-6 space-y-2 text-black">
        ...
        <BenefitsNavigation currentRoute="/benefits/medical-plan-bcbs-prime-hdhp" />
      </div>
      <Footer />
    </div>
  );
...
export default MedicalPlanBCBSPrimeHDHP;
